...
type
  ...
  public
    ...
    property Architecture_watchOSSimulator_x86_64 : Architecture read new Architecture(Triple := "x86_64-apple-watcho-simulator",    Defines := watchOSDefinesSimulatorX64,   SDKName := "watchOS", Simulator := true, Environment := "simulator",  CpuType := cpuType_Penryn, MinimumTargetSDK := "5.0");
