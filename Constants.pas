...
type
  ...
  public
    ...
    property Architecture_iOSSimulator_arm64      : Architecture read new Architecture(Triple := "arm64-apple-ios",         Defines := iOSDefinesSimulatorArm64,     SDKName := "iOS",     Simulator := true, Environment := "simulator",                             MinimumTargetSDK := "14.2");
